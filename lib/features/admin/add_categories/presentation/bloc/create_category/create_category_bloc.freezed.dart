...
class _$CreateNewCategoryEventImpl
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateCategoryEvent.createNewCategory(body: $body)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return createNewCategory?.call(body);
  }
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    return createNewCategory?.call(this);
  }
...
class _$ErrorStateImpl with DiagnosticableTreeMixin implements ErrorState {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CreateCategoryState.error'))
